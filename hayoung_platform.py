...
# --- 3. 가짜 데이터베이스 (수거업체 정보 추가) ---
if 'MOCK_DATA' not in st.session_state:
    st.session_state.MOCK_DATA = [
        {"날짜": "2026-01-15", "학교명": "화성초등학교", "수거업체": "하영자원(본사)", "음식물(kg)": 150, "재활용(kg)": 40, "사업장(kg)": 25, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "정산완료"},
        {"날짜": "2026-01-22", "학교명": "화성초등학교", "수거업체": "하영자원(본사)", "음식물(kg)": 140, "재활용(kg)": 38, "사업장(kg)": 30, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "정산완료"},
        {"날짜": "2026-02-06", "학교명": "화성초등학교", "수거업체": "하영자원(본사)", "음식물(kg)": 145, "재활용(kg)": 42, "사업장(kg)": 20, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "정산완료"},
        {"날짜": "2026-02-13", "학교명": "화성초등학교", "수거업체": "하영자원(본사)", "음식물(kg)": 160, "재활용(kg)": 48, "사업장(kg)": 35, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "정산완료"},
        {"날짜": "2026-02-20", "학교명": "화성초등학교", "수거업체": "하영자원(본사)", "음식물(kg)": 155, "재활용(kg)": 45, "사업장(kg)": 25, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "정산완료"},
        {"날짜": "2026-02-27", "학교명": "화성초등학교", "수거업체": "하영자원(본사)", "음식물(kg)": 150, "재활용(kg)": 50, "사업장(kg)": 30, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "대기중"},
        {"날짜": "2026-02-21", "학교명": "동탄중학교", "수거업체": "A환경(외주)", "음식물(kg)": 210, "재활용(kg)": 60, "사업장(kg)": 50, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "대기중"},
        {"날짜": "2026-02-22", "학교명": "수원고등학교", "수거업체": "B자원(외주)", "음식물(kg)": 180, "재활용(kg)": 55, "사업장(kg)": 40, "단가(원)": 150, "재활용단가(원)": 300, "사업장단가(원)": 200, "상태": "대기중"},
    ]
